...
export default function OrgPage({
  ...
  if (data.loading) return <p className="empty dots">Loading</p>
  if (!org) {
    return (
      <div>
        ...
        <p className="empty">Organization not found.</p>
      </div>
    )
  }
  ...
  return (
    <div className="detail">
      ...
      <div className="list">
        {members.length === 0 ? (
          <p className="empty-inline">No one is linked to this organization yet.</p>
        ) : (
          members.map((m) => (
